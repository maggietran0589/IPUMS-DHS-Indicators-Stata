...
//Circumcised
gen hk_circum = mcirc==1
label values hk_circum yesno
label var hk_circum "Circumcised"

//Circumcision status and provider
gen hk_circum_status_prov= mcircwho 
replace hk_circum_status_prov=3 if mcircwho>2
replace hk_circum_status_prov=0 if mcirc==0
replace hk_circum_status_prov=9 if mcirc==8
