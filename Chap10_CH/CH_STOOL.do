...
recode disposestool	(1=1 "Child used toilet or latrine") (2=2 "Put/rinsed into toilet or latrine") (5=3 "Buried") (3=4 "Put/rinsed into drain or ditch") ///
...
*region
tab GEO-REGION ch_stool_dispose [iw=wt], row nofreq 
...
* output to excel
tabout agecats urban educlvl GEO-REGION wealthq ch_stool_dispose using Tables_Stool.xls [iw=wt], c(row) f(1) replace 
**************************************************************************************************
...
*region
tab GEO-REGION ch_stool_safe [iw=wt], row nofreq 
...
* output to excel
tabout agecats urban educlvl GEO-REGION wealthq ch_stool_safe using Tables_Stool.xls [iw=wt], c(row) f(1) append 
**************************************************************************************************
