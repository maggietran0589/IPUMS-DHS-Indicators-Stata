...
Author:				        Faduma Shaba
Date last modified:   May 2020 by Shireen Assaf 
...
*age
tab age wkearnsmore [iw=wt], row nofreq 

*number of living children
tab chebalive we_earn_wm_compare [iw=wt], row nofreq 

*residence
tab urban we_earn_wm_compare [iw=wt], row nofreq 

*region
tab GEO-REGION we_earn_wm_compare [iw=wt], row nofreq 
...
*region
tab GEO-REGION we_earn_hs_decide [iw=wt], row nofreq 
...
*region
tab GEO-REGION we_own_house [iw=wt], row nofreq 
...
*region
tab GEO-REGION we_own_land [iw=wt], row nofreq 
...
*region
tab GEO-REGION we_house_deed [iw=wt], row nofreq 
...
*region
tab GEO-REGION we_land_deed [iw=wt], row nofreq 
...
*region
tab GEO-REGION we_bank [iw=wt], row nofreq 
